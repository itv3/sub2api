export default {
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentHint: '候选身份的完整 User-Agent，只贡献客户端名与 OS / 架构 / 终端指纹；其中版本段会按候选版本重建。严格 OAuth 出站仍由已验收 ReleaseBundle 终局定型，不会被这里的配置直接覆盖。',
        openaiCodexClientVersion: 'Codex 候选版本号',
        openaiCodexClientVersionPlaceholder: '留空则跟随自动发现',
        openaiCodexClientVersionHint: '用于版本发现、兼容验证与后续画像升级准备；填写后固定候选值。它不会自动激活 strict wire，新版本仍须完成证据采集与 42 项验收。',
        openaiCodexVersionAutoSync: '自动发现 Codex 最新版',
        openaiCodexVersionAutoSyncHint: '每 6 小时从官方仓库发现最新稳定版并保留列表扫描回退。发现值只作为升级候选，不会自动改变当前严格出站画像。',
        openaiCodexVersionSyncedValue: '最新发现：{version}',
        openaiCodexVerifiedVersionValue: 'Strict wire 已激活：{version}',
