export default {
    ...
    accountKeepalive: {
      ...
      labels: {
        ...
        keeperStatus: 'keeper 状态',
        keeperMeta: 'keeper {version} · 项目 {projects} 个 · 题库 {prompts} 条',
        totalAccounts: '总账号数',
        enabledCount: '已启用',
        ...
        save: '保存',
        editQuestion: '编辑问题',
        enableQuestion: '启用这个问题',
        costUnconfigured: '费用：未配置价格',
        estimatedCost: '估算费用',
        cost: '费用',
        tokenUsage: 'Token：{tokens}',
        sessionUsage: '输入 {input} / 输出 {output} / 缓存读取 {cached} / 缓存创建 {cacheCreated}',
        success: '成功',
        failure: '失败'
      },
      placeholders: {
        ...
        customPrompt: '留空则优先从提示词题库抽取；题库为空时使用内置只读问题'
      },
      messages: {
        ...
        selectModel: '请选择模型',
        selectProject: '请选择项目',
        runSubmitted: '已提交立即执行',
        runFailed: '立即执行失败',
        promptRequired: '问题内容不能为空',
        projectPromptNeedsProject: '指定项目问题必须选择项目',
        promptSaved: '提示词设置已保存',
        promptSaveFailed: '保存提示词设置失败'
      }
    },
