export default {
    ...
    accountKeepalive: {
      ...
      labels: {
        ...
        keeperMeta: 'keeper {version} · {projects} projects · {prompts} prompts',
        ...
        runNow: 'Run now',
        history: 'History',
        noConfiguredAccounts: 'No accounts configured yet.',
        ...
        promptGuard: 'Global guard prompt',
        saveGuard: 'Save guard',
        scope: 'Scope',
        promptContent: 'Question content',
        specifiedProject: 'Specific project',
        general: 'General',
        stopped: 'Stopped',
        active: 'Active',
        ...
        enableQuestion: 'Enable this question',
        costUnconfigured: 'Cost: price not configured',
        estimatedCost: 'Estimated cost',
        cost: 'Cost',
        tokenUsage: 'Token: {tokens}',
        sessionUsage: 'Input {input} / Output {output} / Cache read {cached} / Cache create {cacheCreated}',
        success: 'Success',
        failure: 'Failure'
      },
      placeholders: {
        ...
        customPrompt: 'Empty first samples from the prompt bank; if empty, uses the built-in read-only question'
      },
      messages: {
        ...
        promptRequired: 'Question content is required',
        projectPromptNeedsProject: 'Project-scoped questions require a project',
        promptSaved: 'Prompt settings saved',
        promptSaveFailed: 'Failed to save prompt settings'
      }
    },
