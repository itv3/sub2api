...
// EffectiveResponsesTools 返回 Responses 请求中声明的所有客户端可执行工具。
// 较新的 Codex 客户端会将运行时工具放入形如
// {"type":"additional_tools","tools":[...]} 的输入项，而非顶层 tools 字段。
// 仅支持 Chat 接口的上游必须同时接收这两种形式的工具声明。
