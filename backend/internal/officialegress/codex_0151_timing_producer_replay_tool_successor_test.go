...
func validateCodex0151BwrapZstdReadinessToolSuccessor(receipt codex0151ToolReadinessReceipt) error {
	...
	for _, transition := range receipt.Transitions {
		...
		currentDigest := upstreamMergeFrameworkDigest(current)
		if readErr != nil || (currentDigest != transition.ToSHA256 &&
			!codex0151C2PAJobIdentityToolSuccessorSupersedes(
				transition.Path,
				transition.ToSHA256,
				currentDigest,
			)) {
...
func codex0151BwrapZstdReadinessToolSuccessorSupersedes(path, priorDigest, currentDigest string) bool {
	...
	return codex0151C2PAJobIdentityToolSuccessorSupersedes(
		path,
		priorDigest,
		currentDigest,
	)
...
const codex0151C2PAJobIdentityToolSuccessorPath = "docs/egress/maintenance/codex-cli-0151-c2pa-job-identity-tool-successor-source-transition.json"

var (
	codex0151C2PAJobIdentityToolSuccessorOnce   sync.Once
	codex0151C2PAJobIdentityToolSuccessorCached codex0151ToolReadinessReceipt
	codex0151C2PAJobIdentityToolSuccessorErr    error
)

func loadCodex0151C2PAJobIdentityToolSuccessor() (codex0151ToolReadinessReceipt, error) {
	codex0151C2PAJobIdentityToolSuccessorOnce.Do(func() {
		codex0151C2PAJobIdentityToolSuccessorCached, codex0151C2PAJobIdentityToolSuccessorErr =
			readCodex0151C2PAJobIdentityToolSuccessor()
	})
	return codex0151C2PAJobIdentityToolSuccessorCached,
		codex0151C2PAJobIdentityToolSuccessorErr
}

func readCodex0151C2PAJobIdentityToolSuccessor() (codex0151ToolReadinessReceipt, error) {
	var receipt codex0151ToolReadinessReceipt
	raw, err := os.ReadFile(codex01491TerminalRepoPath(codex0151C2PAJobIdentityToolSuccessorPath))
	if err != nil {
		return receipt, err
	}
	decoder := json.NewDecoder(bytes.NewReader(raw))
	...
	if err := validateCodex0151C2PAJobIdentityToolSuccessor(receipt); err != nil {
		return receipt, err
	}
	return receipt, nil
}

func validateCodex0151C2PAJobIdentityToolSuccessor(receipt codex0151ToolReadinessReceipt) error {
	...
	for _, transition := range receipt.Transitions {
		...
		currentDigest := upstreamMergeFrameworkDigest(current)
		if readErr != nil || (currentDigest != transition.ToSHA256 &&
			!codex0151FullJobReadinessToolSuccessorSupersedes(
				transition.Path,
				transition.ToSHA256,
				currentDigest,
			)) {
...
func codex0151C2PAJobIdentityToolSuccessorSupersedes(path, priorDigest, currentDigest string) bool {
	...
	return codex0151FullJobReadinessToolSuccessorSupersedes(
		path,
		priorDigest,
		currentDigest,
	)
...
func TestCodex0151C2PAJobIdentityToolSuccessorSourceTransitionIsFrozen(t *testing.T) {
	if _, err := loadCodex0151C2PAJobIdentityToolSuccessor(); err != nil {
		t.Fatal(err)
	}
}

func TestCodex0151C2PAJobIdentityToolSuccessorSourceTransitionRejectsMutation(t *testing.T) {
	receipt, err := loadCodex0151C2PAJobIdentityToolSuccessor()
	if err != nil {
		t.Fatal(err)
	}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			mutated := receipt
			test.mutate(&mutated)
			if err := validateCodex0151C2PAJobIdentityToolSuccessor(mutated); err == nil {
...
const codex0151FullJobReadinessToolSuccessorPath = "docs/egress/maintenance/codex-cli-0151-full-job-readiness-tool-successor-source-transition.json"

var (
	codex0151FullJobReadinessToolSuccessorOnce   sync.Once
	codex0151FullJobReadinessToolSuccessorCached codex0151ToolReadinessReceipt
	codex0151FullJobReadinessToolSuccessorErr    error
)

func loadCodex0151FullJobReadinessToolSuccessor() (codex0151ToolReadinessReceipt, error) {
	codex0151FullJobReadinessToolSuccessorOnce.Do(func() {
		codex0151FullJobReadinessToolSuccessorCached,
			codex0151FullJobReadinessToolSuccessorErr =
			readCodex0151FullJobReadinessToolSuccessor()
	})
	return codex0151FullJobReadinessToolSuccessorCached,
		codex0151FullJobReadinessToolSuccessorErr
}

func readCodex0151FullJobReadinessToolSuccessor() (codex0151ToolReadinessReceipt, error) {
	var receipt codex0151ToolReadinessReceipt
	raw, err := os.ReadFile(codex01491TerminalRepoPath(codex0151FullJobReadinessToolSuccessorPath))
	if err != nil {
		return receipt, err
	}
	decoder := json.NewDecoder(bytes.NewReader(raw))
	...
	if err := validateCodex0151FullJobReadinessToolSuccessor(receipt); err != nil {
		return receipt, err
	}
	return receipt, nil
}

func validateCodex0151FullJobReadinessToolSuccessor(receipt codex0151ToolReadinessReceipt) error {
	...
	for _, transition := range receipt.Transitions {
		...
		currentDigest := upstreamMergeFrameworkDigest(current)
		if readErr != nil || (currentDigest != transition.ToSHA256 &&
			!codex0151EvidenceLabelPreflightToolSuccessorSupersedes(
				transition.Path,
				transition.ToSHA256,
				currentDigest,
			)) {
...
func codex0151FullJobReadinessToolSuccessorSupersedes(path, priorDigest, currentDigest string) bool {
	...
	return codex0151EvidenceLabelPreflightToolSuccessorSupersedes(
		path,
		priorDigest,
		currentDigest,
	)
...
func TestCodex0151FullJobReadinessToolSuccessorSourceTransitionIsFrozen(t *testing.T) {
	if _, err := loadCodex0151FullJobReadinessToolSuccessor(); err != nil {
		t.Fatal(err)
	}
}

func TestCodex0151FullJobReadinessToolSuccessorSourceTransitionRejectsMutation(t *testing.T) {
	receipt, err := loadCodex0151FullJobReadinessToolSuccessor()
	if err != nil {
		t.Fatal(err)
	}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			mutated := receipt
			test.mutate(&mutated)
			if err := validateCodex0151FullJobReadinessToolSuccessor(mutated); err == nil {
...
const codex0151EvidenceLabelPreflightToolSuccessorPath = "docs/egress/maintenance/codex-cli-0151-evidence-label-preflight-tool-successor-source-transition.json"

var (
	codex0151EvidenceLabelPreflightToolSuccessorOnce   sync.Once
	codex0151EvidenceLabelPreflightToolSuccessorCached codex0151ToolReadinessReceipt
	codex0151EvidenceLabelPreflightToolSuccessorErr    error
)

func loadCodex0151EvidenceLabelPreflightToolSuccessor() (codex0151ToolReadinessReceipt, error) {
	codex0151EvidenceLabelPreflightToolSuccessorOnce.Do(func() {
		codex0151EvidenceLabelPreflightToolSuccessorCached,
			codex0151EvidenceLabelPreflightToolSuccessorErr =
			readCodex0151EvidenceLabelPreflightToolSuccessor()
	})
	return codex0151EvidenceLabelPreflightToolSuccessorCached,
		codex0151EvidenceLabelPreflightToolSuccessorErr
}

func readCodex0151EvidenceLabelPreflightToolSuccessor() (codex0151ToolReadinessReceipt, error) {
	var receipt codex0151ToolReadinessReceipt
	raw, err := os.ReadFile(codex01491TerminalRepoPath(codex0151EvidenceLabelPreflightToolSuccessorPath))
	if err != nil {
		return receipt, err
	}
	decoder := json.NewDecoder(bytes.NewReader(raw))
	...
	if err := validateCodex0151EvidenceLabelPreflightToolSuccessor(receipt); err != nil {
		return receipt, err
	}
	return receipt, nil
}

func validateCodex0151EvidenceLabelPreflightToolSuccessor(receipt codex0151ToolReadinessReceipt) error {
	...
	for _, transition := range receipt.Transitions {
		...
		currentDigest := upstreamMergeFrameworkDigest(current)
		if readErr != nil || (currentDigest != transition.ToSHA256 &&
			!codex0151SystemProxyCaptureToolSuccessorSupersedes(
				transition.Path,
				transition.ToSHA256,
				currentDigest,
			)) {
...
func codex0151EvidenceLabelPreflightToolSuccessorSupersedes(path, priorDigest, currentDigest string) bool {
	...
	for _, transition := range receipt.Transitions {
		if transition.Path == path && transition.FromSHA256 == priorDigest {
			...
			return codex0151SystemProxyCaptureToolSuccessorSupersedes(
				path,
				transition.ToSHA256,
				currentDigest,
			)
...
func TestCodex0151EvidenceLabelPreflightToolSuccessorSourceTransitionIsFrozen(t *testing.T) {
	if _, err := loadCodex0151EvidenceLabelPreflightToolSuccessor(); err != nil {
		t.Fatal(err)
	}
}

func TestCodex0151EvidenceLabelPreflightToolSuccessorSourceTransitionRejectsMutation(t *testing.T) {
	receipt, err := loadCodex0151EvidenceLabelPreflightToolSuccessor()
	if err != nil {
		t.Fatal(err)
	}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			mutated := receipt
			test.mutate(&mutated)
			if err := validateCodex0151EvidenceLabelPreflightToolSuccessor(mutated); err == nil {
