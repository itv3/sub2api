...
const codex0151DeterministicPackageFixtureSourceTransitionPath = "docs/egress/maintenance/codex-cli-0151-deterministic-package-fixture-source-transition.json"

var (
	codex0151DeterministicPackageFixtureSourceTransitionOnce   sync.Once
	codex0151DeterministicPackageFixtureSourceTransitionCached codex0151ToolReadinessReceipt
	codex0151DeterministicPackageFixtureSourceTransitionErr    error
)

func loadCodex0151DeterministicPackageFixtureSourceTransition() (codex0151ToolReadinessReceipt, error) {
	codex0151DeterministicPackageFixtureSourceTransitionOnce.Do(func() {
		codex0151DeterministicPackageFixtureSourceTransitionCached,
			codex0151DeterministicPackageFixtureSourceTransitionErr =
			readCodex0151DeterministicPackageFixtureSourceTransition()
	})
	return codex0151DeterministicPackageFixtureSourceTransitionCached,
		codex0151DeterministicPackageFixtureSourceTransitionErr
}

func readCodex0151DeterministicPackageFixtureSourceTransition() (codex0151ToolReadinessReceipt, error) {
	var receipt codex0151ToolReadinessReceipt
	raw, err := os.ReadFile(codex01491TerminalRepoPath(codex0151DeterministicPackageFixtureSourceTransitionPath))
	if err != nil {
		return receipt, err
	}
	...
	if err := validateCodex0151DeterministicPackageFixtureSourceTransition(receipt); err != nil {
		return receipt, err
	}
	return receipt, nil
}

func validateCodex0151DeterministicPackageFixtureSourceTransition(receipt codex0151ToolReadinessReceipt) error {
	...
	if receipt.Predecessor.Kind != "codex_cli_0151_stopped_ledger_recovery_source_transition" ||
		receipt.Predecessor.Path != codex0151StoppedLedgerRecoverySourceTransitionPath ||
...
func codex0151DeterministicPackageFixtureSourceTransitionSupersedes(path, priorDigest, currentDigest string) bool {
	receipt, err := loadCodex0151DeterministicPackageFixtureSourceTransition()
	if err != nil {
		return false
	}
	for _, transition := range receipt.Transitions {
...
func TestCodex0151DeterministicPackageFixtureSourceTransitionIsFrozen(t *testing.T) {
	if _, err := loadCodex0151DeterministicPackageFixtureSourceTransition(); err != nil {
		t.Fatal(err)
	}
}

func TestCodex0151DeterministicPackageFixtureSourceTransitionRejectsMutation(t *testing.T) {
	receipt, err := loadCodex0151DeterministicPackageFixtureSourceTransition()
	if err != nil {
		t.Fatal(err)
	}
	...
	if err := validateCodex0151DeterministicPackageFixtureSourceTransition(mutated); err == nil {
