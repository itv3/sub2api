...
const codex0151Arm64TypescriptDependencySourceTransitionPath = "docs/egress/maintenance/codex-cli-0151-arm64-typescript-dependency-source-transition.json"

var (
	codex0151Arm64TypescriptDependencySourceTransitionOnce   sync.Once
	codex0151Arm64TypescriptDependencySourceTransitionCached codex0151ToolReadinessReceipt
	codex0151Arm64TypescriptDependencySourceTransitionErr    error
)

func loadCodex0151Arm64TypescriptDependencySourceTransition() (codex0151ToolReadinessReceipt, error) {
	codex0151Arm64TypescriptDependencySourceTransitionOnce.Do(func() {
		codex0151Arm64TypescriptDependencySourceTransitionCached,
			codex0151Arm64TypescriptDependencySourceTransitionErr =
			readCodex0151Arm64TypescriptDependencySourceTransition()
	})
	return codex0151Arm64TypescriptDependencySourceTransitionCached,
		codex0151Arm64TypescriptDependencySourceTransitionErr
}

func readCodex0151Arm64TypescriptDependencySourceTransition() (codex0151ToolReadinessReceipt, error) {
	var receipt codex0151ToolReadinessReceipt
	raw, err := os.ReadFile(codex01491TerminalRepoPath(codex0151Arm64TypescriptDependencySourceTransitionPath))
	if err != nil {
		return receipt, err
	}
	...
	if err := validateCodex0151Arm64TypescriptDependencySourceTransition(receipt); err != nil {
		return receipt, err
	}
	return receipt, nil
}

func validateCodex0151Arm64TypescriptDependencySourceTransition(receipt codex0151ToolReadinessReceipt) error {
...
func TestCodex0151Arm64TypescriptDependencySourceTransitionIsFrozen(t *testing.T) {
	if _, err := loadCodex0151Arm64TypescriptDependencySourceTransition(); err != nil {
		t.Fatal(err)
	}
}

func TestCodex0151Arm64TypescriptDependencySourceTransitionRejectsMutation(t *testing.T) {
	receipt, err := loadCodex0151Arm64TypescriptDependencySourceTransition()
	if err != nil {
		t.Fatal(err)
	}
	...
	if err := validateCodex0151Arm64TypescriptDependencySourceTransition(mutated); err == nil {
