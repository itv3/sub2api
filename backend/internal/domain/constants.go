...
var AntigravityCompatibilityModelMapping = map[string]string{
	...
	"gemini-2.5-flash-image":         "gemini-3-flash-agent",
	"gemini-2.5-flash-image-preview": "gemini-3-flash-agent",
	"gemini-2.5-flash-lite":          "gemini-3.5-flash-extra-low",
	"gemini-2.5-flash-thinking":      "gemini-3.5-flash-low",
	"gemini-2.5-pro":                 AntigravityGemini31ProAgentModel,
	"gemini-3-flash":                 "gemini-3-flash-agent",
	"gemini-3-flash-preview":         "gemini-3-flash-agent",
	...
	"gemini-3-pro-image":             "gemini-3-flash-agent",
	"gemini-3-pro-image-preview":     "gemini-3-flash-agent",
